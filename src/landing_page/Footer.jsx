...
function Footer() {
    return (
        <footer>
            <div className=" border-top" style={{ backgroundColor: '#fbfbfb', paddingRight: '80px', paddingLeft: '80px' }}>
                <div className="row mt-5">
                    <div className="col-3" style={{ paddingRight: '50px' }}>
                        <img style={{ width: '60%' }} src="public\media\logo.svg" alt="logo" />
                ...
                <div style={{ fontSize: '12px' }} className='text-muted mt-5  '>
